...
public class Tuple9<T1,T2,T3,T4,T5,T6,T7,T8,T9> {
  ...
  public T8 v8;
  public T9 v9;
  public Tuple9(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5,
  ...
  public <T10> Tuple10<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10> extend(T10 v10) {
    return Tuple.of(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);
  }
