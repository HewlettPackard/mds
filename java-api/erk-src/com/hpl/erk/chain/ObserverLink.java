...
public class ObserverLink<Head, In> extends Link<Head, In, In> {
  protected ObserverLink(Chain<Head, ? extends In> pred,
                       NullaryFunc<? extends Observer<? super In>> creator) 
  {
    super(pred);
    this.creator = creator;
  }

  protected final NullaryFunc<? extends Observer<? super In>> creator;
  
  @Override
  public Flow pipeInto(final Receiver<? super In> sink) {
    return pred.pipeInto(new ChainedReceiver<In,In>(sink) {
      protected final Observer<? super In> control = creator.call();
