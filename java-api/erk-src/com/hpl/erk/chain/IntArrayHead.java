...
public class IntArrayHead extends GeneratorHead<Integer> {
  protected final int[] array;

  public IntArrayHead(final int[] array) {
    super(new NullaryFunc<Generator<Integer>>() {
      @Override
      public Generator<Integer> call() {
