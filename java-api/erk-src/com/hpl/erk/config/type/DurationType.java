...
import com.hpl.erk.Duration;
import com.hpl.erk.ReadableString;
import com.hpl.erk.config.ex.CantReadError;
import com.hpl.erk.config.ex.ReadError;

public class DurationType extends SimpleType<Duration> {
  public DurationType() {
    super(Duration.class);
  }
  
  @Override
  public Duration readVal(ReadableString input, String valTerminators) throws ReadError {
    int resetTo = input.getCursor();
    Matcher m;
    if ((m = input.consume(Duration.INPUT_PATTERN)) != null) {
      String s = m.group();
