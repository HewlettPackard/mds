...
public abstract class CompositeType<T> extends PType<T> {
  private final GenericType<? super T> generic;
  
  protected CompositeType(GenericType<? super T> generic, TypeToken typeToken) {
    super(typeToken);
  ...
  public void addFunctionTypesTo(Collection<FunctionReturnType> types) {
    ...
    // We don't actually care about the bindings
    types.add(generic);
  }
