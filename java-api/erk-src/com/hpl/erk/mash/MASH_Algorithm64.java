...
public class MASH_Algorithm64 {
  ...
  public static final MASH_Algorithm64 hashall = new MASH_Algorithm64(new CharMapGenerator64.AllChars());
...
//  protected Handler checkStringHandler;
  ...
  public MASH_Algorithm64(long[] map) {
    charMap = map;
  }
  
  public MASH_Algorithm64(CharMapGenerator64 gen) {
    charMap = gen.generate();
  }
  
  public MASH_Algorithm64(DataInput in) throws IOException {
