...
public class Test7 {
  static final Logger log = Logger.getLogger(Test7.class);
  static final RunContext rc = RunContext.GLOBAL.subContext("test7").activate();
  ...
  {
    args = RunConfig.process(Test7.class, args);

    FinalModificationRec.create.record();
  }
}
