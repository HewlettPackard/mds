...
public class Test4 extends TestBase {
  static final Logger log = Logger.getLogger(Test4.class);
  static final RunContext rc = testRC.subContext("test4").activate();


  public static void main(String[] args)
    throws ConfigErrorsSeen, IOException
  {
    args = RunConfig.process(Test4.class, args);
