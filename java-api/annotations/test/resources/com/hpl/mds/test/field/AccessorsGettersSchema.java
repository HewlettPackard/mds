...
@RecordSchema
public interface AccessorsGettersSchema {
	
	@Protected(Emitted.ACCESSORS)@No(Emitted.SETTER)
	String myProtected();
	
	@Public(Emitted.GETTER)@No(Emitted.SETTER)
	String myPublic();
	
	@Private(Emitted.ALL)@No(Emitted.SETTER)
	String myPrivate();
