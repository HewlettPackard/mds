...
@RecordSchema
public interface AccessorsSettersSchema {

	@Protected(Emitted.ACCESSORS)@No(Emitted.GETTER)
	String myProtected();
	
	@Public(Emitted.SETTER)@No(Emitted.GETTER)
	String myPublic();
	
	@Private(Emitted.ALL)@No(Emitted.GETTER)
	String myPrivate();
}
