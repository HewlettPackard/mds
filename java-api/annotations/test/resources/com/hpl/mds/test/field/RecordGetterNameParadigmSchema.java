...
@RecordSchema
@Paradigm("com.hpl.mds.test.valid.TestParadigmGetterName")
@No({ Emitted.SETTER, Emitted.MODIFIERS })
public interface RecordGetterNameParadigmSchema {

    int testNum();

    ManagedBoolean testBool();
