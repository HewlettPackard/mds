...
public interface RecordWithParadigmSchema {

    static void RecordWithParadigm(RecordWithParadigm.Private self, int val) {
    }

    static String myMethod(RecordWithParadigm.Private self, int val) {
